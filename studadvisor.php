...
<body>
<form action="studadvisor1.php" method="post" target="_self">
<p style="font-weight: bold">List of Student Adviser:</p>
      </blockquote>
        
	    <blockquote>
	      <pre>
         
Name of Teacher: <select  type="text" name="s_adviser">
        ...
        <option value="Shyla Afroz, Lecturer, CSE, RUET, Rajshahi">Shyla Afroz, Lecturer, CSE, RUET, Rajshahi.</option>
          ...
          <input type="submit" value="submit data"  onclick="alert('New data being added to student advisor')" /> </pre>
          </blockquote>
          </form>          
</body>
</html>