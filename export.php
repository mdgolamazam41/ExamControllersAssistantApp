...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr>
    ...
    <tr>
    <td ><div id="topnav-inner" class="style17" align="center">
    <nav>
    <ul  class="nav">
          <li> <a href="ruetcse.html">home</a></li>
         <li><a href="4thsemister.php">4th semester</a></li>
         <li><a href="new_record.php">New record</a></li>
         ...
         <li id="export_r"><a href="export.php">export record</a>
              <ul>
...
<div id="export">
<div id="one">
<a href="exporting_into_word.php">1. export to word doc</a></div>
<div>
<a href="exporting_into_excel.php">2. export to excell file</a></div>
</div><!-- end div export -->
</body>
</html>